...
<div class="container" style="max-width: 500px;">
  <form name="myform" method="post">
    ...
    <img src="${ctp}/images/logo.png" width="100px"/></h3>
    <div class="mb-3">
      <label for="mid" class="form-label">아이디</label>
      <input type="text" name="mid" id="mid" value="${mid}" placeholder="아이디를 입력하세요" autofocus required class="form-control" />
    </div>
    <div class="mb-3">
      <label for="pwd" class="form-label">비밀번호</label>
      <input type="password" name="pwd" id="pwd" value="0000" placeholder="비밀번호를 입력하세요." required class="form-control" />
    </div>
    ...
    <div class="d-flex justify-content-center align-items-center gap-3">
      ...
      <a href="javascript:midSearch()" class="text-decoration-none">아이디 찾기</a>
      <span>/</span>
      <a href="javascript:pwdSearch()" class="text-decoration-none">비밀번호 찾기</a>
    </div>
  </form>
</div>
<p><br/></p>
