...
<div class="container">
  <form name="myform" method="post">
      ...
      <tr>
        <th>비밀번호</th>
        <td><input type="password" name="pwd" id="pwd" value="0000" placeholder="비밀번호를 입력하세요." required class="form-control" /></td>
      </tr>
      <tr>
        <td colspan="2">
          <input type="submit" value="로그인" class="btn btn-success me-2"/>
          <a href="javascript:kakaoLogin()" class="m-2"><img src="${ctp}/images/kakao_login.png" width="160px"/></a>
