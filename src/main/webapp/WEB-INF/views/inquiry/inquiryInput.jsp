      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="form-text text-muted">- 업로드 가능파일은 'jpg/gif/png/zip/ppt/pptx/hwp' 입니다.</div>
        ...
        <tr>
          <td colspan="2" class="text-center">
            ...
            <input type="button" value="돌아가기" onclick="location.href='inquiryList';" class="btn btn-info"/>
          </td>
        </tr>
      </table>
